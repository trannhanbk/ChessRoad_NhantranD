...
import 'package:chessroad_app/routes/battle-page.dart';
      ...
      child: Column(
        children: [
          ...
          Transform.scale(
            ...
            child:
                Text('CỜ TƯỚNG', style: nameStyle, textAlign: TextAlign.center),
          ),
          // Expanded(child: SizedBox()),
          // InkWell(
          //   // child: Text('单机对战', style: menuItemStyle),
          //   child: Text('CHƠI MỘT NGƯỜI', style: menuItemStyle),
          //   onTap: () {},
          // ),
          Expanded(child: SizedBox()),
          InkWell(
            // child: Text('挑战云主机', style: menuItemStyle),
            child: Text('NEW GAME', style: menuItemStyle),
            onTap: () => navigateTo(BattlePage()),
          ),
          // Expanded(child: SizedBox()),
          // InkWell(
          //   // child: Text('排行榜', style: menuItemStyle),
          //   child: Text('BẢNG XẾP HẠNG', style: menuItemStyle),
          //   onTap: () {},
          // ),
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          menuItems,
          Positioned(
            top: chessroad_appApp.StatusBarHeight + 44,
            left: 20,
            child: InkWell(
              child: Icon(Icons.settings, color: ColorConstants.Primary),
              onTap: () {
